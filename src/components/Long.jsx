...
const Long = () => {
    ...
    useEffect(() => {
        let todostring = localStorage.getItem("todos-Long")
        if (todostring) {
            let oldtodo = JSON.parse(localStorage.getItem("todos-Long"));
            setTodos(oldtodo);
            // console.log(todos);
        }
    ...
    const saveToLS = () => {
        localStorage.setItem("todos-Long", JSON.stringify(todos));
    }
